<?php namespace Nord\ElasticsearchBundle\Search\Aggregation\Metrics;

use Nord\ElasticsearchBundle\Search\Aggregation\Aggregation;
 ...
 * single-value and multi-value numeric metrics aggregations plays a role when these aggregations serve as direct sub-
 * aggregations of some bucket aggregations (some bucket aggregations enable you to sort the returned buckets based on
